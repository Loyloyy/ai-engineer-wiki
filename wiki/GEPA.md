...
- **A prompt is a horrible abstraction for programming.** It conflates the task spec (what you actually want) with model-specific tricks (phrasing that happened to work), inference strategies (chain of thought, agent loop), and formatting directives. Changing the model forces re-writing all of this. The right separation is: natural language task spec + evals (what success looks like) + code (tools, control flow) + swappable model/inference layer — these should be independently modifiable. — Omar Khattab, DSPy & Databricks ("On Engineering AI Systems that Endure The Bitter Lesson", AI Engineer World's Fair 2025), [https://www.youtube.com/watch?v=qdmxApz3EJI](https://www.youtube.com/watch?v=qdmxApz3EJI)
...
- Omar Khattab, DSPy & Databricks, "On Engineering AI Systems that Endure The Bitter Lesson", AI Engineer World's Fair 2025 — [https://www.youtube.com/watch?v=qdmxApz3EJI](https://www.youtube.com/watch?v=qdmxApz3EJI)
